...
import { CreditCard, Eye, EyeOff, Mail, Lock, ArrowLeft } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="backdrop-blur-sm bg-white/80 border-white/20 shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-slate-600">Sign in to your Payflox account to continue</CardDescription>
          </CardHeader>
